...
class _FlyingTokenAnimationState extends State<FlyingTokenAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scaleAnimation = Tween(begin: 1.0, end: 0.5)
...
class _FlyingCardAnimationState extends State<FlyingCardAnimation> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(begin: 1.0, end: 0.2) // Thu nhỏ lại khi vào kho
